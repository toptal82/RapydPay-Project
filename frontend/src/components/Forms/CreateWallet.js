...
function CreateWallet() {
    ...
    const [isExist, setExistError] = useState(false);

    let value_ewallet_reference_id = Math.floor(Math.random() * 10000000000) + 1 + Math.floor(Math.random() * 10000000000) + 1;
    let balance = 0;

    const [wallet, setWallet] = useState({
        "first_name": "",
        "last_name": "",
        "ewallet_reference_id": value_ewallet_reference_id,
        "type": "person",
        "phone_number": "",
        "email": "",
        "balance": balance
    ...
    const InputEvent = (event) => {
        ...
        //generate unique ewallet_reference_id
        const data = `${wallet.first_name}${wallet.last_name}${wallet.phone_number}${wallet.email}`;
        let ref_id = sha256(data).toString();
        //remove space part
    ...
    const getWalletDetails = () => {
        ...
        console.log("getWalletDetail: ",wallet);
                ...
                <FormWrap>
                    ...
                    <FormContent>
                        <Form post >
                            ...
                            {/* {isExist === true && <p style={{ color: "#00ff00" }}>Your phoneNumber or email is invalid. </p>} */}
